        ...
        {STEPS.map((s, i) => (
          <li key={s.title} className="bg-bg">
            <Reveal delay={i * 90} className="flex h-full flex-col p-7 md:p-8">
              <span className="font-display text-6xl font-bold text-ink/10">0{i + 1}</span>
              <code className="mt-6 inline-flex w-fit rounded-md bg-ink px-2.5 py-1 font-mono text-[0.72rem] text-paper">
